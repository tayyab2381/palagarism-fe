...
const baseClassName =
  "inline-flex items-center justify-center bg-obsidian text-white text-sm font-medium px-4 py-3 rounded-pill shadow-cta hover:opacity-90 transition-opacity";
